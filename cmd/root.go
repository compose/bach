...
var RootCmd = &cobra.Command{
	Use:   "bach",
	Short: "Basic API Compose Handler",
	Long:  `Bach is designed as simple route to accessing the Compose API`,
}
...
func initConfig() {
	...
	viper.SetConfigName(".bach")           // name of config file (without extension)
